...
how_to.addEventListener('click', function() {
    ...
    $('#lesson-story').html("<p>Using the satellite map of the Calais Jungle we've created a digital map, which is one of the many outcomes of the <a target=\"_blank\" href=\"http://themasterpiecetour.projectfuel.in/\">Masterpiece Tour 2016</a>. Click on any of the blue wisdom pins that you see on the map to discover life lessons from Calais refugees who we met during our 10-day-stay at the camp. The yellow pins on the map are life lessons of volunteers from <a href=\"http://www.laubergedesmigrants.fr\">L'auberge des migrants</a>, who generously devoted their time to the camp. </p><p>These life lessons are of men and women who have walked for seven months across the forests of Bulgaria, have drank diesel to hydrate themselves in the Sahara desert, have been imprisoned in Libya for absence of documents and most importantly, have been separated from a sense of home over and over again. Delve into Calais with these life lessons and then, pass on the map so someone else may explore the legacy too.</p>").hide().fadeIn(duration);
    $('#lesson-banner').css('background-image', 'url(build/images/pictures/' + img + '.jpg)').hide().fadeIn(duration);
